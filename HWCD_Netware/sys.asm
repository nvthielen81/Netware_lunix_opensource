...
; of the interupts the jump true the program clock caller ascii and the 0x00 for the bios bit call up.
; ; and the FET file electron trasmiter cloack of the CPU that e Frion system is the recat on headt and coldt
